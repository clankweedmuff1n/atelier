...
@Component({
  ...
  template: `
    <section class="px-20 py-12 flex flex-col">
      ...
      <div class="flex justify-center flex-col lg:flex-row gap-8">
        <div *ngFor="let card of cards">
          <img class="object-cover object-center max-h-[288px] lg:max-h-[320px] lg:w-[430px] hover:translate-x-[-15px] duration-700 transition-all h-full" [src]="card.img" [alt]="card.title"/>
